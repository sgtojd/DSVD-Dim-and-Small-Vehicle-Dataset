...
• If you need to use our dataset to make research, please cite our essay **(The essay is acceped and the link is below)**.
~~~
@article{shi2023adaptive,
  title={Adaptive feature fusion with attention-guided small target detection in remote sensing images},
  author={Shi, Tianjun and Gong, Jinnan and Hu, Jianming and Zhi, Xiyang and Zhu, Guiyi and Yuan, Binhuan and Sun, Yu and Zhang, Wei},
